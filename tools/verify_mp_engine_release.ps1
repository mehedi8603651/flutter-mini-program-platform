...
Write-Host "- Publisher API: run contract validate/smoke/handoff against a disposable middle server."
Write-Host "- Host import: import a handoff package into a disposable host and run flutter run -d chrome."
Write-Host "- Do not run destroy, delete, cleanup, or other destructive cloud/provider commands from this script."
