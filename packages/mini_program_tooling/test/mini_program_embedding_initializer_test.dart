...
void main() {
  group('MiniProgramEmbeddingInitializer', () {
    ...
    test('creates embedding adapter files using pubspec defaults', () async {
      ...
      expect(updatedPubspec, contains('mini_program_sdk: ^0.6.6'));
      expect(updatedPubspec, contains('mini_program_contracts: ^0.3.11'));
      ...
      expect(readme, contains('mini_program_sdk: ^0.6.6'));
      expect(readme, contains('mini_program_contracts: ^0.3.11'));
