...
void main() {
  group('MiniProgramEmbeddingInitializer', () {
    ...
    test('creates embedding adapter files using pubspec defaults', () async {
      ...
      expect(updatedPubspec, contains('mini_program_sdk: ^0.5.10'));
      expect(updatedPubspec, contains('mini_program_contracts: ^0.3.4'));
      expect(updatedPubspec, isNot(contains('mini_program_legacy_stac:')));
      expect(readme, contains('mini_program_sdk: ^0.5.10'));
      expect(readme, contains('mini_program_contracts: ^0.3.4'));
