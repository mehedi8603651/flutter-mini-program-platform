const String androidFileTransferProviderSource =
...
class AppAndroidFileTransferProvider
  ...
  Future<bool> cancel(String transferId) async {
    ...
    try {
      ...
      throw _fileException(error, MiniProgramErrorCodes.fileTransferUnavailable);
  ...
  static int? _optionalInt(Object? value) => value == null
      ? null
      : _requiredInt(value);
