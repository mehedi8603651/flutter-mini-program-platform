...
Commands:
  ...
  host capability init <location|file|camera|flashlight|qr|audio|video> --platform android [--project-root <path>]
...
Commands:
  ...
  capability init <location|file|camera|flashlight|qr|audio|video> --platform android
''';
...
Commands:
  init <location|file|camera|flashlight|qr|audio|video> --platform android [--project-root <path>] [--json]
''';
