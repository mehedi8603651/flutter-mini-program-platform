...
extension CliResultFormatters on CliContext {
  ...
  String formatHostEndpointAddResult(MiniProgramHostEndpointAddResult result) {
    return <String>[
      ...
      'Policy file: ${result.policyFilePath}',
      'Policy resolver file: ${result.policyResolverFilePath}',
  ...
  String formatHostEndpointImportResult({
    ...
    return <String>[
      ...
      'Policy file: ${endpointResult.policyFilePath}',
      'Policy resolver file: ${endpointResult.policyResolverFilePath}',
