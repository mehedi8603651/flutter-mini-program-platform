...
class HostBridgeImpl implements HostBridge {
  ...
  Future<HostActionResult> openNativeScreen(
    ...
    if (navigator == null) {
      return HostActionResult.failed(
        ...
        message: 'The partner host navigator is not available.',
      );
    }
    ...
    try {
      ...
      if (payload.expectResult && result == null) {
        return HostActionResult.cancelled(
          actionName: ActionNames.openNativeScreen,
          message: 'The partner native screen closed without a result.',
      ...
      return HostActionResult.success(
        actionName: ActionNames.openNativeScreen,
        message: 'Opened partner native screen "$routeName".',
        data: result == null
      ...
      debugPrint(
        '[partner_app_host][ERROR] Failed to open native route '
        '"${payload.route}". error=$error\n$stackTrace',
      );
      return HostActionResult.failed(
        actionName: ActionNames.openNativeScreen,
        message: 'Failed to open partner native screen "${payload.route}".',
      );
    }
  }
  ...
  Future<HostActionResult> trackEvent(TrackEventActionPayload payload) async {
    ...
    debugPrint(
      '[partner_app_host][analytics] ${payload.name} ${payload.properties}',
    );

    return HostActionResult.success(
      actionName: ActionNames.trackEvent,
      message: 'Tracked partner event "${payload.name}".',
